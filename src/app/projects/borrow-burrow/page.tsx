        ...
        <section>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            <div>
              ...
              <p className="mt-2 text-gray-600">The user's homepage provides areas to preview pending borrow requests from other users, along with lists of items they are currently borrowing or lending out to others.</p>
            </div>
            <div>
              <Image
              ...
              <p className="mt-2 text-gray-600">Full list of items added by other members, available for borrowing or giveaway. Short list of all community members.</p>
            </div>
            <div>
              <Image
                src="/images/borrow-burrow/item-detail.png"
              ...
              <p className="mt-2 text-gray-600">Dialog window that provides more details on an available item, as well as a place to request to borrow.</p>
            </div>
          </div>
        </section>
        <section>
          <h2 className="text-2xl font-semibold mt-6 mb-4">Future Plans</h2>
          <p className="mt-2 text-gray-600">A project is never complete! I'm planning to continue expanding the feature set of this app with these possible ideas:</p>
          <ul>
